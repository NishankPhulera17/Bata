  ...
  return (
    <View style={{ alignItems: "center", justifyContent: "center", width: '100%' }}>
      ...
      <View style={{ height: 60, width: '86%', borderWidth: 1, borderColor: '#DDDDDD', alignItems: "center", justifyContent: "center", backgroundColor: 'white', margin: 10, flexDirection: 'row' }}>
        ...
        <TextInput editable={!aadharVerified} maxLength={12} onSubmitEditing={(text) => { handleInputEnd() }} onEndEditing={(text) => { handleInputEnd() }} style={{ height: 50, width: '80%', alignItems: "center", justifyContent: "center", fontWeight: '500', color: 'black', fontSize: 16, position: 'absolute', left: 14 }} placeholderTextColor="grey" onChangeText={(text) => { handleInput(text) }} value={value} placeholder={required ? `${placeHolder} *` : `${placeHolder}`}></TextInput>
