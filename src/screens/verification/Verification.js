          ...
          {showAadhar &&
            <View style={{
              ...
              <View style={{ height: 70, width: '90%', borderWidth: 1, borderColor: '#DDDDDD', alignItems: "flex-start", marginTop: 20 }}>
                ...
                <View style={{ alignItems: "center", justifyContent: 'flex-start', flexDirection: "row", width: '100%', height: 40 }}>
                  <TextInput multiline = {true} textContentType='oneTimeCode' value={otp} onChangeText={(text) => {
                    handleOtpInput(text)  
                  }} style={{ alignItems: 'center', justifyContent: 'center', width: '82%', height: 40, fontSize: 16, letterSpacing: 1, marginLeft: 20, color: 'black' }} placeholderTextColor="black" placeholder='Enter OTP'>
                  </TextInput>
                  {aadhaarOtpSent && 
